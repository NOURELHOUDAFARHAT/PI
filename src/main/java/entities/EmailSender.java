...
public class EmailSender {
    ...
    private static final String EMAIL_USERNAME = "noorfarhat45@gmail.com";
    private static final String EMAIL_PASSWORD = "rbms hguk hrzh qmxa"; // Utiliser le mot de passe d'application pour Gmail
